...
public class UnileverplantasTestContainer extends TestContainer {

    public UnileverplantasTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/tiemsa/unilever/app.properties",
    ...
    public static class Common extends UnileverplantasTestContainer {

        public static final UnileverplantasTestContainer.Common INSTANCE = new UnileverplantasTestContainer.Common();
